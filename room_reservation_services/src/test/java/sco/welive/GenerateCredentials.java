...
public class GenerateCredentials {
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
            GenerateCredentials.class.getResourceAsStream("/client_secret.json");
        ...
        System.err.println("accessToken:"+credential.getAccessToken());
        System.err.println("refreshToken:"+credential.getRefreshToken());
